    ...
    return (
        <main>
            <section className="lg:px-12 sm:px-8 x-sm:px-4 py-16 flex justify-center items-center bg-gradient-to-r from-sky-500 to-indigo-500">
                <h1 className="md:text-[8rem] sm:text-[6rem] x-sm:text-[3rem] font-bold leading-none text-white text-center">What Is <br /> SkillZEE?</h1>
            </section>
            <section className="lg:px-12 sm:px-8 x-sm:px-4 py-16 max-w-[700px] mx-auto">
                ...
                <p className="text-gray-500 text-[1.1rem] font-[500] mb-10">Welcome to SkillZEE, the ultimate platform for job seekers and recruiters alike. Our mission is to connect talented individuals with the right job opportunities, helping them achieve their career goals and grow professionally.</p>
                ...
                <p className="text-gray-500 text-[1.1rem] font-[500] mb-10">At SkillZEE, we believe in empowering talents to achieve their career goals and grow professionally. That's why we have created a comprehensive resource center that provides insights, tips, and resources to help you succeed in your career.<br /><br />
